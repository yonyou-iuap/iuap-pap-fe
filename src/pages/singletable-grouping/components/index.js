...
class SingleTableGrouping extends Component {
    ...
    expandedRowRender = (record, index, indent) => {
        ...
        let {
            pageParams: { pageIndex, total, totalPages }
        } = subTableAllPaging[record.key];
        return (
            <div>
                <Grid
    ...
    exportExcel = async () => {
        ...
        const { queryParam, masterTableList } = this.props;
        const { groupParams } = queryParam;
        let exportData=[];
        if (groupParams && groupParams.length > 0) {
            let result = await actions.grouping.getDataForGroupExcel({
                ...queryParam
                // pageParams:{
                //     pageSize: 1,
                //     pageIndex: 0
    ...
    render() {
        ...
        let { tableHeight, exportData } = this.state;
        ...
        return (
            <div className="grouping u-grid">
                ...
                <SearchPanel className="grouping-form" searchOpen={true} form={form} reset={() => this.props.form.resetFields()} intl={intl} onCallback={this.resetTableHeight} search={this.onSearch}>
                            ...
                            <FormItem>
                                ...
                                <Select placeholder={<FormattedMessage id="js.group.search.sel.0005" defaultMessage="选择分组" />} multiple {...getFieldProps("group")}>
                                    <Option disabled value="">
                                        {<FormattedMessage id="js.group.search.sel.0002" defaultMessage="请选择" />}
                                    </Option>
                    ...
                    <Row className="form-panel">
                        <Col md={4} xs={6}>
                            <FormItem>
                                ...
                                <FormControl placeholder={this.props.intl.formatMessage({ id: "js.group.search.0002", defaultMessage: "模糊查询" })} {...getFieldProps("code", { initialValue: "" })} />
                            </FormItem>
                        </Col>
                        <Col md={4} xs={6}>
                            <FormItem>
                                <Label>{<FormattedMessage id="js.group.search.0003" defaultMessage="员工姓名" />}</Label>
                                <FormControl placeholder={this.props.intl.formatMessage({ id: "js.group.search.0004", defaultMessage: "模糊查询" })} {...getFieldProps("name", { initialValue: "" })} />
                            </FormItem>
                        </Col>
                        <Col md={4} xs={6}>
                            <FormItem>
                                ...
                                <Select {...getFieldProps("exdeeds", { initialValue: "" })}>
                                    <Option disabled value="">
                                        {<FormattedMessage id="js.group.search.sel1.0002" defaultMessage="请选择" />}
                                    </Option>
                    ...
                    <Row className="form-panel">
                        ...
                        <Col md={4} xs={6}>
                            <FormItem className="time">
                                ...
                                <YearPicker format={"YYYY"} locale={zhCN} placeholder={this.props.intl.formatMessage({ id: "js.group.search.0007", defaultMessage: "选择年份" })} {...getFieldProps("year", { initialValue: "" })} />
                            </FormItem>
                        </Col>
                    </Row>
                </SearchPanel>
